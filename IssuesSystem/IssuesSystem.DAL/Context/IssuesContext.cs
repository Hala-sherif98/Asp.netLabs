...
namespace IssuesSystem.DAL.Context
{
    //in this class we want to create our own context that allows us create our database using our classes (code-first)
    public class IssuesContext : DbContext
    {
        public DbSet<Ticket> Tickets => Set<Ticket>(); //when we require dbset of tickets, will get the table that maps to these tickets
