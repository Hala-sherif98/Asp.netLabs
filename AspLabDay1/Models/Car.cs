namespace AspLabDay1.Models
{
    ...
    public class Car
    {
        ...
        {
            return $"Name : {Model} from {Manufacturer} , Usage Duration: {((DateTime.Now).Year) - (FirstUseDate.Year)} years , Description: {HtmlDescription.Replace("<p>","").Replace("</p>","")}";
        }
